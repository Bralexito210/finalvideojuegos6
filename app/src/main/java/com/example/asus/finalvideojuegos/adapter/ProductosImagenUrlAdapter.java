...
implements View.OnClickListener{
    //ESTO ES PARA EL CLICK EN TABLA EL IMPLEMENTS
    List<Producto> listProducto;
    private View.OnClickListener listener;//ESTO ES PARA EL CLICK EN TABLA
    ...
    public UsuariosHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vista.setOnClickListener(this);//ESTO ES PARA EL CLICK EN TABLA
...
//sol oborra el contenido nomas
    ...
    public class UsuariosHolder extends RecyclerView.ViewHolder{
        ...
        public UsuariosHolder(View itemView) {
            super(itemView);
            txtMarca= (TextView) itemView.findViewById(R.id.idMarca);
            txtPrecio= (TextView) itemView.findViewById(R.id.idPrecio);
            txtPeso= (TextView) itemView.findViewById(R.id.idPeso);
